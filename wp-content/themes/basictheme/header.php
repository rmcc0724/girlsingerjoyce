	...
	<header class="bg-dark">
		<div class="row">
			<div class='col-12 d-flex justify-content-center text-white pt-3'>
				<h3 class="text-center display-5 my-0">JOYCE McCULLOCH</h3>
			</div>
		</div>
		<div class="row">
		...
		<div class="row">
			<div class="col-12 d-none d-md-block justify-content-center text-center">
		...
		<div class="row">
			<div class="col-12 d-xs-block d-md-none text-center">
				<div class="w-50 m-auto pt-4">
					<img id="mobile-photo" class="rounded" style="max-width: 200px; min-width: 150px;" src="/wp-content/uploads/2018/07/Joyce_about_mobile-300x300.jpg" alt="Joyce McCulloch" /></p>
				</div>
			</div>
		</div>
		<div class="row">
